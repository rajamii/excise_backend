# Generated by Django 5.1.4 on 2025-06-25 05:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=20, validators=[contact_us.validators.validate_phone_number])),
                ('email', models.EmailField(max_length=254, validators=[contact_us.validators.validate_email])),
                ('office_level', models.CharField(choices=[('Head Quarter', 'Head Quarter'), ('Permit Section', 'Permit Section'), ('Administration Section', 'Administration Section'), ('Accounts Section', 'Accounts Section'), ('IT Cell', 'IT Cell')], default='Excise Head Office', max_length=255, validators=[contact_us.validators.validate_office_level])),
