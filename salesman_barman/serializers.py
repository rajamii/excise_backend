...
from .models import SalesmanBarmanModel, SalesmanBarmanDocumentModel
...
class SalesmanBramanDocumentSerializer (serializers.ModelSerializer):

    passPhoto              = serializers.CharField()
    aadharCard             = Serializers.CharField()
    residentialCertificate = serializers.CharField()
    dateofBirthProof       = serializers.CharField()

    class Meta:
        model = SalesmanBarmanDocumentModel
