    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_image_document', models.FileField(max_length=500, upload_to=upload_site_image)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['content_type', 'object_id'], name='site_enquir_content_1637b5_idx'), models.Index(fields=['license_id'], name='site_enquir_license_056028_idx')],
