    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_stage', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='applications', to='workflow.workflowstage')),
                ('excise_district', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='license_excise_districts', to='core.district')),
                ('excise_subdivision', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='license_excise_subdivisions', to='core.subdivision')),
                ...
                ('site_subdivision', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='license_site_subdivisions', to='core.subdivision')),
                ('workflow', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='applications', to='workflow.workflow')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='workflow.workflowstage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='objections', to='license_application.licenseapplication')),
                ('raised_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='license_objections', to=settings.AUTH_USER_MODEL)),
                ('stage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='license_objection_stage', to='workflow.workflowstage')),
            ],
            options={
